...
if(!$conn_isernia) {
	...
	$query_istanza = "SELECT id_istanza, string_agg(concat('F',foglio,' M',mappale), ', ') as terreni, data_istanza, motivo, inviato, n_bolli, file_s, estremi_s, file_bi, estremi_bi, file_bc, estremi_bc, file_bc_integr, estremi_bc_integr, file_cdu, terminato, dt.descr as tipo
		...
		on dt.cod = i.tipo
		where i.id_utente = $1
		group by d.id_istanza, i.data_istanza, i.motivo, i.inviato, i.n_bolli, ps.file_s, ps.estremi_s, pbi.file_bi, pbi.estremi_bi, pbc.file_bc, pbc.estremi_bc, pbc.file_bc_integr, pbc.estremi_bc_integr, i.file_cdu, i.terminato, dt.descr
