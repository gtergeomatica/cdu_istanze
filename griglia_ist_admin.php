...
if(!$conn_isernia) {
	...
	$query_istanza = "SELECT id_istanza, string_agg(concat('F',foglio,' M',mappale), ', ') as terreni, usr_login, concat(firstname,' ',lastname) as nome, usr_email, nascosto, data_istanza, inviato, file_txt, n_bolli, file_s, estremi_s, file_bi, estremi_bi, file_bc, estremi_bc, file_bc_integr, estremi_bc_integr, file_cdu, terminato, data_invio, dt.descr as tipo
			...
			group by d.id_istanza, u.usr_login, u.firstname, u.lastname, u.usr_email, u.nascosto, i.data_istanza, i.inviato, i.file_txt, i.n_bolli, ps.file_s, ps.estremi_s, pbi.file_bi, pbi.estremi_bi, pbc.file_bc, pbc.estremi_bc, pbc.file_bc_integr, pbc.estremi_bc_integr, i.file_cdu, i.terminato, i.data_invio, dt.descr
