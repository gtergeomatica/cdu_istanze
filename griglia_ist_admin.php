...
if(!$conn_isernia) {
	...
	/* $query_istanza = "SELECT id_istanza, string_agg(concat('F',foglio,' M',mappale), ', ') as terreni, data_istanza, file_s, file_bi, file_bc
		...
		;"; */
	$query_istanza = "SELECT id_istanza, string_agg(concat('F',foglio,' M',mappale), ', ') as terreni, usr_login, usr_email, nascosto, data_istanza, inviato, file_txt, n_bolli, file_s, file_bi, file_bc, file_cdu, terminato
			...
			group by d.id_istanza, u.usr_login, u.usr_email, u.nascosto, i.data_istanza, i.inviato, i.file_txt, i.n_bolli, ps.file_s, pbi.file_bi, pbc.file_bc, i.file_cdu, i.terminato
